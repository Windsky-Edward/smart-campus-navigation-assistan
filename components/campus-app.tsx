...
const copy = {
  English: {
    ...
    route: {
      ...
      head: "Head towards",
      headDetail: "Stay on the shaded walkway and follow the blue route markers.",
  ...
  "Bahasa Melayu": {
    ...
    route: {
      ...
      head: "Menuju ke",
      headDetail: "Ikut laluan berbumbung dan penanda laluan biru.",
